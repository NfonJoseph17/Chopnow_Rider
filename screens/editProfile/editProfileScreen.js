...
import { Dimensions, Text, View, Image, Modal, ScrollView, TouchableOpacity, TextInput, StyleSheet, Platform } from "react-native";
...
const EditProfileScreen = ({ navigation }) => {
    ...
    const [fullName, setFullName] = useState('Krish Joe');
    ...
    const [email, setEmail] = useState('joekrish@gmail.com');
